...
def encode_label(data_frame):
    ...
    """ 
    data_frame["VisitorType"]= label_encode.fit_transform(data_frame["VisitorType"])
    data_frame["Weekend"]= label_encode.fit_transform(data_frame["Weekend"])
    data_frame["Revenue"]= label_encode.fit_transform(data_frame["Revenue"])

    the same as bellow ,just for testing
    """
